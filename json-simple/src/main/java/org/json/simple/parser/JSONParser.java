...
public class JSONParser
{
		...
		throws IOException, ParseException
	{
				...
				case S_PASSED_PAIR_KEY:
					...
					case Yytoken.TYPE_VALUE: {
						...
						Map<String, Object> parent =
							(Map<String, Object>)valueStack.getFirst();
		...
		{
			throw ie; //** What was the sense of this? (Re-throwing single
				// caught exception makes no sense… It just adds an item to
				// a stack trace, but it has no point either.)
		}*/
	...
	private Map<String, Object> createObjectContainer(
	...
	private List<Object> createArrayContainer(
		ContainerFactory containerFactory)
	{
		if (containerFactory == null)
			return new JSONArray();
		List<Object> l = containerFactory.createArrayContainer();
