...
public class Test extends TestCase
{
	...
	public void testDecode() throws Exception
	{
		...
		try {
			Map<String, Object> json =
				(Map<String, Object>)parser.parse(s, containerFactory);
	...
	public void testEncode() throws Exception
	{
		...
		Map<String, Object> m3 = new LinkedHashMap<String, Object>();
			//** TODO – Check! It was just an attempt to add types to a raw
			// typed map… didn’t not compile – I had no JUnit installed…
		m3.put("k31", "v3");
